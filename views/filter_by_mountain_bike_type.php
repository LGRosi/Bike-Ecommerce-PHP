...
$filteredTypeOfBike = Bike::filter($bikes, 'tipoDeBicicleta', 'Bicicleta de Montaña');
?>

<section class="pt-32">
    <?php if (!empty($filteredTypeOfBike)) { ?>
        <h1 class="text-center text-4xl font-bold text-gray-800 pt-4 mb-4">Bicicletas de Montaña</h1>
