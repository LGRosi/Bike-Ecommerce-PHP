...
$filteredBrand = Bike::filter($bikes, 'marca', 'Venzo');
?>

<section class="pt-32">
    <?php if (!empty($filteredBrand)) { ?>
        <h1 class="text-center text-4xl font-bold text-gray-800 pt-4 mb-4">Bicicletas Marca Venzo</h1>

        <article class="py-10 bg-gray-100">
            <div class="mx-auto grid max-w-6xl  grid-cols-1 gap-6 p-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <?php foreach ($filteredBrand as $product) { ?>
